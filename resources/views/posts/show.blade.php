            ...
            <main class="max-w-7xl mx-auto mt-8 px-4 sm:px-6 lg:px-8">
                <article class="bg-white rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div class="relative">
                        ...
                        @else
                            <img src="https://picsum.photos/seed/news/1200/600"
                                alt="{{ ucwords(strtolower($post['title'])) }}" class="w-full h-96 object-cover">
                        @endif

                        <!-- Breaking News label -->
                        <div class="absolute top-0 left-0 bg-red-500 text-white px-4 py-2 rounded-br-lg">
                            @foreach ($post['categories'] as $category)
                                <span>{{ ucwords(strtolower($category['name'])) }}</span>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="p-6 sm:p-10">
                        <h2 class="text-3xl font-bold text-gray-900 mb-4">{{ ucwords(strtolower($post['title'])) }}</h2>
                        ...
                        <div class="flex items-center text-sm text-gray-500 mb-6">
                            ...
                            <span>
                                ...
                                Category:
                                {{ isset($category) ? ucwords(strtolower($category['name'])) : 'Not available' }}
