            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach (range(1, 8) as $index)
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                        <img src="https://picsum.photos/seed/{{ $index }}/400/300" alt="News Image"
                            class="w-full h-48 object-cover">
                        <div class="p-4">
                            <h2 class="text-xl font-semibold mb-2">Nigerian Senators' Monthly Pay Exceeds N2 Billion:
                                Controversy Over Legislative Salaries</h2>
                            ...
                            <div class="flex items-center justify-between text-sm mb-2">
                                <span class="font-medium">By: Shola Akinyele</span>
                                <span class="text-purple-600">Category: Local</span>
                            </div>
