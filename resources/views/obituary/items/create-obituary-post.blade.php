        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <div id="caveat-bubble" class="fixed bottom-4 right-4 animate-bounce-in">
                <div class="relative group">
                    <!-- Main bubble -->
                    <div
                        class="bg-white-500 text-black px-6 py-3 rounded-full shadow-lg flex items-center space-x-2 cursor-pointer hover:bg-yellow-600 transition-all duration-300">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        <span class="font-medium">Obituary Mode Active</span>
                    </div>
