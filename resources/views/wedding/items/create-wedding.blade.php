        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <div id="caveat-bubble" class="fixed bottom-4 right-4 animate-bounce-in">
                <div class="relative group">
                    <!-- Main bubble -->
                    <div
                        class="bg-cyan-500 text-white px-6 py-3 rounded-full shadow-lg flex items-center space-x-2 cursor-pointer hover:bg-yellow-600 transition-all duration-300">
